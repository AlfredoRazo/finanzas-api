...
export class LoginComponent implements OnInit {
  ...
  ngOnInit(): void {
    if (this.isEmbeded) {
      ...
      let token = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..xIOdAvqjNRM0gGE817Ra3m4XRw7knUxk5Qef8D3SJYY';
