...
export class LoginComponent implements OnInit {
  ...
  ngOnInit(): void {
    if (this.isEmbeded) {
      ...
      let token = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..bgsMpxdsjiLbLQq5qF3JmLgh_-zGLmppltFAud7uuPI';
