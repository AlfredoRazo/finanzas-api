...
export class LoginComponent implements OnInit {
  ...
  ngOnInit(): void {
    if (this.isEmbeded) {
      ...
      let token = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..nKc62Nr6Slj4CFf0XxBw9pEvSCBwcJBdX_624CX9F2A';
