...
export class LoginComponent implements OnInit {
  ...
  ngOnInit(): void {
    if (this.isEmbeded) {
      ...
      let token = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..UoNhDKmuuDjmJxeujpWYHYrer2Rfm_YEI9W49vSR388';
