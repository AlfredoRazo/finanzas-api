export const environment = {
  ...
  santanderResponse: 'https://pis-app-finanzas-prod.azurewebsites.net/finanzas-api/santander10',
  bbvaEndpoint: 'https://prepro.adquiracloud.mx/clb/endpoint/apimanzanillo',
  bbvaSuccessRes: 'https://pis-app-finanzas-prod.azurewebsites.net/finanzas-api/bbva10',
  bbvaFailRes: 'https://pis-app-finanzas-prod.azurewebsites.net/finanzas-api/santanderE10',
