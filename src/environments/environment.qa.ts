export const environment = {
  ...
  endpointApi: 'https://pis-api-finanzas-federado.azurewebsites.net/api/',
  ...
  endpointCat: 'https://pis-api-catalogos-federado-qa.azurewebsites.net/api/',
  ...
  endpointEstadoHechos: 'https://pis-api-estadohechos.azurewebsites.net/api/',
  ...
  santanderResponse: 'https://pis-app-finanzas-qa.azurewebsites.net/finanzas-api/santander10',
